...
const BookingPage = () => {
  ...
  const locations = ["Al Amarat", "Al Awabi", "Al Hamra", "Al Jazir", "Al Kamil Wal Wafi", "Al-Mudhaibi", "Al-Musannah", "Al Qabil", "Barka", "Bidbid", "Bidiya", "Bowshar", "Dhank", "Dima Wa Tharafayn", "Duqm", "Haima", "Ibra", "Ibri", "Izki", "Jalan Bani Bu Ali", "Jalan Bani Bu Hassan", "Khaburah", "Khasab", "Liwa", "Madha", "Mahdah", "Mahout", "Manah", "Masirah", "Matrah", "Mirbat", "Muscat", "Nakhal", "Nizwa", "Qurayyat", "Rakhyut", "Rustaq", "Saham", "Samail", "Seeb", "Shinas", "Sohar", "Sur", "Taqah", "Thumrait", "Wadi Al Maawil", "Wadi Bani Khalid", "Yanqul"];
